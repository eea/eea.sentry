...
casper.test.begin('Add-on Install', function(test) {
   ...
   /* submit form */
   casper.waitForSelector("form input[value='eea.sentry:default']",
       function success() {
           test.assertExists("form input[value='eea.sentry:default']", "eea.sentry check box is present");
           this.click("form input[value='eea.sentry:default']");
       },
       function fail() {
           test.assertExists("form input[value='eea.sentry:default']", "eea.sentry check box is present");
   });
